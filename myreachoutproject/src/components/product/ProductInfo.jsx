  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="mt-2 text-4xl font-semibold tracking-tight text-[#111111] sm:text-5xl">{product.title}</h1>
      ...
      <div className="rounded-[2rem] border border-black/10 bg-[#f7f7f2] p-6 shadow-sm">
...
=======
        <div className="mt-5 flex flex-col gap-3 sm:flex-row">
          <Button variant="gold" className="flex-1 justify-center rounded-xl px-5 py-3.5">
            Add to cart
          </Button>
          <Button variant="outline" className="flex-1 justify-center rounded-xl px-5 py-3.5">
            Save for later
>>>>>>> Stashed changes
          </Button>
        </div>
